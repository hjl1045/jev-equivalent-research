# Ten synthetic auto-claims documents

All organizations, people, identifiers, and events are fictional. These are simple classification smoke tests, not operational forms. Gold categories were excluded from model inputs.

## doc_01 — expected: police_report

SYNTHETIC TRAINING DOCUMENT — NO REAL PERSON OR EVENT
...
## doc_04 — expected: medical_record
...
## doc_05 — expected: repair_estimate
...
## doc_06 — expected: rental_invoice
...
## doc_07 — expected: witness_statement
...
## doc_08 — expected: coverage_letter
...
## doc_09 — expected: subrogation_notice
...
## doc_10 — expected: settlement_release
